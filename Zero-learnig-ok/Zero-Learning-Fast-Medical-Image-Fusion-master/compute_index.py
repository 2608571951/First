...
import os
IMAGE_PATH1 = '/home/root3203/lishanshan/TheWholeBrainAtlas/test2/MR-T1/'
IMAGE_PATH2 = '/home/root3203/lishanshan/TheWholeBrainAtlas/test2/MR-T2/'
IMAGE_PATH3 = './result1/'
...
def comp_idx():
    ...
    for i in range(18):
        num = 3 * (i + 14)
        image1 = Image.open(IMAGE_PATH1 + str(num) + '.png')
        image2 = Image.open(IMAGE_PATH2 + str(num) + '.png')
        image3 = Image.open(IMAGE_PATH3 + str(num) + '.png')
    ...
    print('1', (SSIM1 + SSIM2) / 36)
    # print('1', SSIM2 / 18)
    print('1', (NMI1 + NMI2) / 36)
    # print('1', NMI2 / 18)
    print('1', (CC1 + CC2) / 36)
    # print('1', CC2 / 18)
    # print('1', EN/18)
    ...
    print('SSIM1: {0}; SSIM2: {1}; NMI1: {2}; NMI2: {3}; CC1: {4}; CC2: {5}; EN: {6}; SF: {7}'.format(SSIM1, SSIM2, NMI1, NMI2, CC1, CC2, EN, SF))
