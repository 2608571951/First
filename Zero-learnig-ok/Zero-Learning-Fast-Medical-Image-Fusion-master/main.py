...
def make_args_parser():
    ...
    parser.add_argument('-i', '--images', nargs='+', type=str,
                        default=['/home/root3203/lishanshan/TheWholeBrainAtlas/test2/MR-T1/93.png',
                                 '/home/root3203/lishanshan/TheWholeBrainAtlas/test2/MR-T2/93.png'],
                        help='define path to images')
    parser.add_argument('-o', '--output', default='./result1/93.png',
